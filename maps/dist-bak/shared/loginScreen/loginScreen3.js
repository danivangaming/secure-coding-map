"use strict";
let password3 = document.getElementById('link3');
let input3 = document.getElementById('password3');
let login3 = document.getElementById('login3');
let button_container3 = document.getElementById('button-container3');
let button13 = document.getElementById('button_13');
let button23 = document.getElementById('button_23');
let button33 = document.getElementById('button_33');
...
function execute() {
    let right_password = document.getElementById('right-password3');
...
//# sourceMappingURL=loginScreen3.js.map