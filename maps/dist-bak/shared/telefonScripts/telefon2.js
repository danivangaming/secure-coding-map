"use strict";
let answer_option1_2 = document.getElementById("first_answer_option1");
let answer_option2_2 = document.getElementById("first_answer_option2");
...
function show_second_2() {
    document.body.innerHTML =
        '<div class="telefon_container">' +
            ...
            '    </div>' +
            '</div>';
    answer_option1_2 = document.getElementById("second_answer_option1");
    answer_option2_2 = document.getElementById("second_answer_option2");
    answer_option1_2.onmouseover = function () {
        answer_option1_2.style.textDecoration = "underline";
    };
    answer_option2_2.onmouseover = function () {
...
function show_third_2() {
    document.body.innerHTML =
        '<div class="telefon_container">' +
            ...
            '    </div>' +
            '</div>';
    answer_option1_2 = document.getElementById("third_answer_option1");
    answer_option2_2 = document.getElementById("third_answer_option2");
    answer_option1_2.onmouseover = function () {
        answer_option1_2.style.textDecoration = "underline";
    };
    answer_option2_2.onmouseover = function () {
...
//# sourceMappingURL=telefon2.js.map