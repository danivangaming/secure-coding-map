"use strict";
let answer_option1 = document.getElementById("first_answer_option1");
let answer_option2 = document.getElementById("first_answer_option2");
...
function show_second() {
    document.body.innerHTML =
        '<div class="telefon_container">' +
            ...
            '    </div>' +
            '</div>';
    answer_option1 = document.getElementById("second_answer_option1");
    answer_option2 = document.getElementById("second_answer_option2");
    answer_option1.onmouseover = function () {
        answer_option1.style.textDecoration = "underline";
    };
    answer_option2.onmouseover = function () {
...
function show_third() {
    document.body.innerHTML =
        '<div class="telefon_container">' +
            ...
            '    </div>' +
            '</div>';
    answer_option1 = document.getElementById("third_answer_option1");
    answer_option2 = document.getElementById("third_answer_option2");
    answer_option1.onmouseover = function () {
        answer_option1.style.textDecoration = "underline";
    };
    answer_option2.onmouseover = function () {
...
//# sourceMappingURL=telefon1.js.map