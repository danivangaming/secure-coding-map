...
WA.room.onEnterLayer("quest_3_1_zone").subscribe(() => {
    if (!mail_1_quest_done) {
        currentItem = WA.ui.openPopup("quest_3_1", "", [
            {
...
WA.room.onEnterLayer("quest_3_2_zone").subscribe(() => {
    if (!mail_2_quest_done) {
        currentItem = WA.ui.openPopup("quest_3_2", "", [
            {
                label: TextFiles.trustworthy_label,
                className: "success",
                callback: (popup) => {
...
WA.room.onEnterLayer("quest_3_3_zone").subscribe(() => {
    if (!mail_3_quest_done) {
        currentItem = WA.ui.openPopup("quest_3_3", "", [
            {
                label: TextFiles.trustworthy_label,
                className: "success",
                callback: (popup) => {
...
function questMatch(quest = "") {
    ...
    if (WA.state.loadVariable("quest_3_1") &&
